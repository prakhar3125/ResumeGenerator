...
// Section Order Preview Component
const SectionOrderPreview = ({ sectionOrder }) => {
    const sectionNames = {
        education: 'Education',
    ...
    <div className="flex flex-col lg:flex-row min-h-screen" style={{ backgroundColor: 'var(--color-background)' }}>
        ...
        <div className="w-full lg:w-1/2 p-4 flex flex-col h-screen" style={{ backgroundColor: 'var(--color-surface-secondary)' }}>
            <div className="flex justify-between items-center mb-4 p-3 surface rounded-lg">
        <h2 className="text-xl font-bold" style={{ color: 'var(--color-foreground)' }}>
            Resume Preview
            {isCompiling && (
                <span className="ml-3 text-sm font-normal flex items-center gap-2" 
        ...
        <div className="flex items-center gap-3">
            ...
            <div className="flex-grow surface rounded-lg overflow-hidden">
                {isCompiling && (
                    <div className="flex items-center justify-center h-full text-center" style={{ color: 'var(--color-foreground-secondary)' }}>
                        <div>
                ...
                {compilationError && !isCompiling && (
                    <div className="bg-red-100 border-l-4 border-red-500 text-red-800 p-4 m-4 rounded-md h-full overflow-y-auto">
                        ...
                        >
                            <div className="flex items-center justify-center h-full">
                                <div className="text-center">
                                    ...
                                    <a 
                                        href={pdfUrl} 
                                        className="btn-primary inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium mt-2"
                                    >
                                        <Download size={16} /> Download PDF
                                    </a>
                                </div>
